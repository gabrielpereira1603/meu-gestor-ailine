<div>
    ...
    >
        ...
        <div class="relative z-10 max-w-4xl mx-auto text-center px-4 sm:mt-0 mt-10">
    ...
    <section
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
            ...
            <p class="text-lg text-gray-700 mb-12">
                ...
                Compare nossos planos e escolha aquele que combina com suas necessidades.
            </p>

            {{-- 3.3) Grid com 3 planos --}}
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                {{-- Plano 1: Básico --}}
                <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col">
                    {{-- Cabeçalho do card --}}
                    <h3 class="text-xl font-semibold text-blue-900 mb-2">Plano Básico</h3>
                    ...
                    <div class="flex items-baseline justify-center mb-6">
                        <span class="text-4xl font-extrabold text-pink-500">R$ 49</span>
                ...
                {{-- Plano 2: Plus --}}
                <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col border-2 border-pink-500">
                    {{-- Cabeçalho do card --}}
                    <h3 class="text-xl font-semibold text-blue-900 mb-2">Plano Plus</h3>
                    <p class="text-sm text-gray-500 mb-6">
                        Ideal para quem busca consultas ilimitadas e exames básicos.
                    </p>

                    {{-- Preço --}}
                    <div class="flex items-baseline justify-center mb-6">
                        <span class="text-4xl font-extrabold text-pink-500">R$ 99</span>
                        <span class="text-gray-500 ml-1 self-end">/mês</span>
                    </div>
                    ...
                    <ul class="space-y-3 text-left mb-8 flex-1">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Consultas ilimitadas ■</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-pink-500 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-700">Exames básicos inclusos</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-pink-500 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-700">Acesso prioritário a especialistas</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-pink-500 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-700">Descontos em exames laboratoriais</span>
                        </li>
                    </ul>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col">
                    {{-- Cabeçalho do card --}}
                    <h3 class="text-xl font-semibold text-blue-900 mb-2">Plano Premium</h3>
                    <p class="text-sm text-gray-500 mb-6">
                        Nosso pacote completo, com todos os benefícios e serviços exclusivos.
                    </p>

                    {{-- Preço --}}
                    <div class="flex items-baseline justify-center mb-6">
                        <span class="text-4xl font-extrabold text-pink-500">R$ 149</span>
                        <span class="text-gray-500 ml-1 self-end">/mês</span>
                    </div>
                    ...
                    <ul class="space-y-3 text-left mb-8 flex-1">
                        ...
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Exames completos inclusos</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-pink-500 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-700">Equipe de especialistas dedicados</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-pink-500 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-700">Acesso a terapias e planos personalizados</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-pink-500 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-700">Convênio com farmácias e clínicas parceiras</span>
                        </li>
                    </ul>
